...
function App() {
  ...
  return (
    <div className="w-full flex flex-col items-center gap-6 py-8 animate-in fade-in">
      ...
      default:
        return (
          <div className="py-12 border-4 border-dashed border-white/5 rounded-[2rem] hover:border-purple-500/30 transition-all group cursor-pointer w-full flex flex-col items-center">
            <Upload className="mx-auto text-purple-500 group-hover:scale-110 group-hover:-translate-y-1 transition-transform" size={64} strokeWidth={1} />
            <p className="mt-6 text-xl font-medium text-gray-300">Makale (PDF) dosyasını <span className="text-purple-500 font-bold">seçin</span></p>
            ...
            <div className="lg:col-span-3 bg-[#0f172a]/70 p-9 rounded-[2.2rem] border border-white/10 backdrop-blur-md shadow-lg">
              ...
              <div className="relative h-52">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center text-center">
                    <span className="text-5xl font-black text-white leading-none">{novelty}%</span>
